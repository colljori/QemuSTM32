...
#define FLASH_OBR_BOR_LEV                   (0x000F0000)
#define FLASH_OBR_USER                      (0x00700000)
#define FLASH_OBR_IWDG_SW                   (0x00100000)
#define FLASH_OBR_nRST_STOP                 (0x00200000)
#define FLASH_OBR_nRST_STDBY                (0x00400000)
#define FLASH_OBR_nRST_BFB2                 (0x00800000)
